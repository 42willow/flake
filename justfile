...
starling:
  sudo nix --extra-experimental-features "nix-command flakes" run nix-darwin/nix-darwin-26.05#darwin-rebuild -- switch --flake ~/Documents/git/flake#starling 2>&1 | nix run nixpkgs#nix-output-monitor --extra-experimental-features "nix-command flakes"
